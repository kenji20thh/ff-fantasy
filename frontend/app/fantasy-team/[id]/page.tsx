...
export default function FantasyTeamBuilderPage() {
  ...
  function getPlayerPhoto(playerID: number) {
  ...
  async function loadInitialData() {
    ...
    try {
      ...
      if (viewedFantasyId !== null) {
        ...
        const selectedUnlockedDays = loadedDays
          .filter((day) => {
            const hasSelection =
            ...
            return hasSelection && isUnlocked;
          })
          .sort((a, b) => b.id - a.id);
        ...
        const initialDay = selectedUnlockedDays[0] ?? firstUnlocked;
